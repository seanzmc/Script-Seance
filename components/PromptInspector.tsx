...
export const PromptInspector: React.FC<PromptInspectorProps> = ({ traces, onClear }) => (
  <div className="fixed bottom-4 right-4 z-40 w-[min(94vw,460px)] rounded-xl border border-emerald-400/35 bg-gray-950/95 p-3 shadow-[0_18px_40px_rgba(0,0,0,0.45)] backdrop-blur">
