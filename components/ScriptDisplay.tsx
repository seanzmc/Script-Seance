...
import { SCRIPT_EXPORT_ROOT_ATTRIBUTE } from '../services/scriptPdfExport';
...
export const ScriptDisplay: React.FC<ScriptDisplayProps> = ({
  ...
  useEffect(() => {
    ...
    requestAnimationFrame(() => {
      if (el) {
        if (revealScrollMode === 'scene-generation-later') {
  ...
  }, [revealScrollMode, revealScrollTargetId, revealScrollToken]);
  ...
  return (
    <div
      ...
      {...{ [SCRIPT_EXPORT_ROOT_ATTRIBUTE]: 'true' }}
    >
