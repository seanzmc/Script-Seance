...
const previousEnv = {
  SCRIPT_SEANCE_OPENAI_API_KEY: process.env.SCRIPT_SEANCE_OPENAI_API_KEY,
...
afterAll(() => {
  process.env.SCRIPT_SEANCE_OPENAI_API_KEY = previousEnv.SCRIPT_SEANCE_OPENAI_API_KEY;
