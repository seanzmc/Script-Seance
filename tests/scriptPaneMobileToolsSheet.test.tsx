...
describe('ScriptPane header generation and audio drawer', () => {
  ...
  it('formats title metadata and uses matching title/style edit link styling', () => {
    ...
    expect(generateButton.parentElement?.parentElement?.parentElement?.className).toContain('flex-col');
    expect(generateButton.parentElement?.parentElement?.parentElement?.className).toContain('xl:items-end');
    expect(generateButton.parentElement?.parentElement?.parentElement?.className).toContain('flex-col');
    expect(generateButton.parentElement?.parentElement?.parentElement?.className).toContain('items-stretch');
    expect(generateButton.parentElement?.parentElement?.className).not.toContain('flex-wrap');
    expect(generateButton.parentElement?.className).toContain('flex-1');
    expect(generateButton.parentElement?.className).toContain('min-w-0');
    expect(generateButton.parentElement?.className).toContain('xl:flex-none');
    expect(generateButton.parentElement?.parentElement?.className).toContain('w-full');
    expect(generateButton.parentElement?.parentElement?.className).toContain('xl:w-auto');
    expect(generateButton.parentElement?.parentElement?.className).toContain('xl:items-center');
    expect(undoButton.parentElement?.className).toContain('min-w-0 flex-1');
    expect(undoButton.parentElement?.className).toContain('xl:flex-none');
    expect(audioButton.parentElement?.className).toContain('min-w-0 flex-1');
    expect(audioButton.parentElement?.className).toContain('xl:flex-none');
